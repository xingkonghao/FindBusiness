...
+ (MBProgressHUD *)showProgressHUDWithText:(NSString *)text isTouched:(BOOL)touched inView:(UIView *)view progressTintColor:(UIColor *)progressTintColor
{
    return [[DFYGProgressHUD sharedHUD]showProgressHUDWithText:text isTouched:touched inView:view progressTintColor:progressTintColor];
}
- (MBProgressHUD *)showProgressHUDWithText:(NSString *)text isTouched:(BOOL)touched inView:(UIView *)view progressTintColor:(UIColor *)progressTintColor {
    if (view == nil) {
        view = [UIApplication sharedApplication].keyWindow;
